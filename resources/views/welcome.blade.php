    ...
    <footer class="text-center text-white">
        ...
        <div class="container p-4 pb-0">
            ...
            <section class="mb-4">
                ...
                <!-- Instagram -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/ezerzuniga.oficial16/" role="button" target="_blank" rel="noopener noreferrer">
                ...
                <!-- Linkedin -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://www.linkedin.com/in/ezer-benito-zu%C3%B1iga-chura-721145387" role="button" target="_blank" rel="noopener noreferrer">
                ...
                <!-- Github -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://github.com/EzerZuniga" role="button" target="_blank" rel="noopener noreferrer">
