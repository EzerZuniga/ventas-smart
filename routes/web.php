...
// Rutas para las versiones modernas
use App\Http\Controllers\ModernViewController;

Route::group(['prefix' => 'modern'], function() {
    Route::get('/login', [ModernViewController::class, 'login'])->name('modern.login');
    Route::get('/dashboard', [ModernViewController::class, 'dashboard'])->name('modern.dashboard');
});
